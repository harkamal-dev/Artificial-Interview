			...
			<div className="flex gap-6 mt-2 flex-wrap">
				{interviewList && interviewList.length
					? interviewList.map((item) => (
							<div
								key={item.id}
								className="min-w-72 bg-secondary shadow-lg rounded-lg flex flex-col gap-2 justify-start text-xl font-semibold hover:scale-105 transition-all p-6"
							>
								<p className="text-base">
									<strong className="font-bold">Job Position: </strong>
									{item.jobPosition}
								</p>
								<p className="text-base">
